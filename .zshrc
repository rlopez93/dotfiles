...
source $HOME/VulkanSDK/Releases/1.4.313.0/setup-env.sh

# export VULKAN_SDK=~/VulkanSDK/Releases/1.4.313.0/x86_64/
...
less() {
    tmux set mouse off 2>/dev/null
    command less "$@"
    tmux set mouse on 2>/dev/null
}
